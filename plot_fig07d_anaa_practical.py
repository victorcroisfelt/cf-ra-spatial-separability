...
data_cellfree_est1_fixed = np.load('data/fig07_08_cellfree_est1_fixed_practical.npz')
data_cellfree_est2_fixed = np.load('data/fig07_08_cellfree_est2_fixed_practical.npz')
data_cellfree_est3_fixed = np.load('data/fig07_08_cellfree_est3_fixed_practical.npz')

data_cellfree_est1_flexible = np.load('data/fig07_08_cellfree_est1_flexible_practical.npz')
data_cellfree_est2_flexible = np.load('data/fig07_08_cellfree_est2_flexible_practical.npz')
data_cellfree_est3_flexible = np.load('data/fig07_08_cellfree_est3_flexible_practical.npz')
